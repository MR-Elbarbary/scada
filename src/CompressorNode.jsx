...
import Compressorsvg from "./assets/compressor_dynamic.svg?react";
...
export default function CompressorNode({
  id = 'CP-101',
  ...
  return (
    <>
      ...
      >
          <Compressorsvg width="100%" height="100%" />
      </div>
