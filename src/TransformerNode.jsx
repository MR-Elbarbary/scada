...
import Transformerersvg from "./assets/transformer_dynamic.svg?react";
...
export default function TransformerNode({
  ...
  return (
    <>
      ...
      >
          <Transformerersvg width="100%" height="100%" />
      </div>
